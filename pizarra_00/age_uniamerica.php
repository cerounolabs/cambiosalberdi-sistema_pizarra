...
<html>
	<head>
		...
		<title>Pizarra - Agencia Uniamerica</title>
		<style>
			html{
				width: 100%;
				height: 100%;
	...
	<body>
		<?php
			...
			echo '<tr><td style="width:100%; font-family:Arial Black; font-weight:bold; font-size:22px; color:green;" colspan="3">AGENCIA UNIAMERICA</td></tr>';
