...
<html>
	<head>
		...
		<title>Pizarra - Sucursal Salto del Guair&aacute;</title>
		<style>
			html{
				width: 100%;
				height: 100%;
	...
	<body>
		<?php
			ibase_connect("10.168.198.130:aliadocambios", "sysdba", "dorotea");
			
			echo '<table style="width:100%; height:100%; text-align:center; padding:2px;" border="1" cellpadding="1" cellspacing="1">';
			echo '<tr><td style="width:100%; font-family:Arial Black; font-weight:bold; font-size:22px; color:green;" colspan="3">SUCURSAL SALTO DEL GUAIRA</td></tr>';
