...
<html>
	<head>
		...
		<title>Pizarra - Agencia San Lorenzo</title>
		<style>
			html{
				width: 100%;
				height: 100%;
	...
	<body>
		<?php
			ibase_connect("10.168.191.130:aliadocambios", "sysdba", "dorotea");
			
			echo '<table style="width:100%; height:100%; text-align:center; padding:2px;" border="1" cellpadding="1" cellspacing="1">';
			echo '<tr><td style="width:100%; font-family:Arial Black; font-weight:bold; font-size:35px; color:green;" colspan="3">AGENCIA SAN LORENZO</td></tr>';
			...
			while ($R = ibase_fetch_object($Q)) {
				...
				$ini_moneda='<td style="text-align:left; 	font-family:Arial Black; font-weight:bold; color:black; font-size:35px;">';
				$ini_compra='<td style="text-align:center; 	font-family:Arial Black; font-weight:bold; color:black; font-size:35px;">';
				$ini_venta= '<td style="text-align:center; 	font-family:Arial Black; font-weight:bold; color:black; font-size:35px;">';
				$fin_moneda="</td>";
