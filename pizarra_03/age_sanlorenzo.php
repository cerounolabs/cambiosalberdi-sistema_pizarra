...
<html>
	<head>
		...
		<title>Cierre BCP - Agencia San Lorenzo</title>
		<style>
			html{
				width: 100%;
				height: 100%;
	...
	<body>
		<?php
			$str_db         = '10.168.191.130:aliadocambios';
			$str_user       = 'sysdba';
			$str_pass       = 'dorotea';
			...
			echo '<tr><td style="width:100%; font-family:Arial Black; font-weight:bold; font-size:16px; color:green;" colspan="3">AGENCIA SAN LORENZO</td></tr>';
