...
<html>
	<head>
		...
		<title>Cierre BCP - Agencia Uniamerica</title>
		<style>
			html{
				width: 100%;
				height: 100%;
	...
	<body>
		<?php
			$str_db         = '10.168.199.131:aliadocambios';
			$str_user       = 'sysdba';
			$str_pass       = 'dorotea';
			...
			echo '<tr><td style="width:100%; font-family:Arial Black; font-weight:bold; font-size:16px; color:green;" colspan="3">AGENCIA UNIAMERICA</td></tr>';
