...
<html>
	<head>
		...
		<title>Cierre BCP - Sucursal Ciudad del Este</title>
		<style>
			html{
				width: 100%;
				height: 100%;
	...
	<body>
		<?php
			...
			echo '<tr><td style="width:100%; font-family:Arial Black; font-weight:bold; font-size:16px; color:green;" colspan="3">SUCURSAL 1 CIUDAD DEL ESTE</td></tr>';
