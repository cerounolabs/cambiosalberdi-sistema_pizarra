<HTML>
	...
	<BODY>
		...
		<?php
			...
			echo '<td align="center" style="center-align: top; font-family: Arial Black; font-weight: bold; color: green; background-color: white";><div style="text-align: center; font-size:22px">PAGE</font></td>';
		?>
		<!---
		<table> 
