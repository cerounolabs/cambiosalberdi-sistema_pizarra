<HTML>
	...
	<BODY>
		...
		<?php
			...
			echo '<td align="center" style="center-align: top; font-family: Arial Black; font-weight: bold; color: green; background-color: white";><div style="text-align: center; font-size:22px">RUBIO ÑU</font></td>';
		?>
		<!---
		<table> 
		...
		<?php
			...
			ibase_connect("10.168.195.130:aliadocambios", "sysdba", "dorotea");
