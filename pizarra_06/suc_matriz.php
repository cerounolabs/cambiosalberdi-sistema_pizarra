...
<html>
	<head>
		...
		<title>Pizarra - Casa Matriz</title>
		<style>
			html{
				width: 100%;
				height: 100%;
	...
	<body>
		<?php
			...
			echo '<tr><td style="width:100%; font-family:Arial Black; font-weight:bold; font-size:60px; color:green;" colspan="3">CASA MATRIZ</td></tr>';
			...
			while ($R = ibase_fetch_object($Q)) {
				...
				$ini_moneda='<td style="text-align:left; 	font-family:Arial Black; font-weight:bold; color:black; font-size:50px;">';
				$ini_compra='<td style="text-align:center; 	font-family:Arial Black; font-weight:bold; color:black; font-size:50px;">';
				$ini_venta= '<td style="text-align:center; 	font-family:Arial Black; font-weight:bold; color:black; font-size:50px;">';
				$fin_moneda="</td>";
				
				if (($R->ID_MONEDA) == 16 OR ($R->ID_MONEDA) == 10 OR ($R->ID_MONEDA) == 12 OR ($R->ID_MONEDA) == 13 OR ($R->ID_MONEDA) == 14) {
